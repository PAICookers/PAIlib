...
from paicorelib.framelib.frame_defs import FrameFormatV2 as FFV2
from paicorelib.framelib.frame_defs import FrameHeaderV2 as FHV2
...
class TestOfflineFrameGenV2:
    ...
    def _parse_packet_header(self, frame):
        ...
        start_addr = (
            p_payload >> FFV2.GENERAL_PACKAGE_NEU_START_ADDR_OFFSET
        ) & FFV2.GENERAL_PACKAGE_NEU_START_ADDR_MASK
        num = (
            p_payload >> FFV2.GENERAL_PACKAGE_NUM_OFFSET
        ) & FFV2.GENERAL_PACKAGE_NUM_MASK
        return pkg_type, start_addr, num

    # =========================================================================
    # 1. Work & Control Frames (Single Frame)
    # =========================================================================
    ...
    # =========================================================================
    # 2. Config Frames (Packet Protocol)
    # =========================================================================
    ...
    def test_gen_neuron_config_full(self):
        ...
        frames = OfflineFrameGenV2.gen_neuron_config(
            0, 0, neurons, start_addr=0, mode="full"
        )
